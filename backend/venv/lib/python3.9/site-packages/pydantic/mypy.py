...
class PydanticModelTransformer:
    ...
    def collect_field_or_class_var_from_stmt(  # noqa C901
        ...
        if isinstance(node, TypeAlias):
            ...
            # but the only alternative would be to modify the SymBuildifyable,
    ...
    def _infer_dataclass_attr_init_type(self, sym: SymBuildifyableNode, name: str, context: Context) -> Type | None:
    ...
    def set_frozen(self, fields: list[PydanticModelField], api: SemanticAnalyzerPluginInterface, frozen: bool) -> None:
        ...
        for field in fields:
            ...
            if sym_node is not None:
                ...
                info.names[var.name] = SymBuildifyableNode(MDEF, var)
...
def add_method(
    ...
    if is_classmethod:
        ...
        dec.line = info.line
        sym = SymBuildifyableNode(MDEF, dec)
    else:
        sym = SymBuildifyableNode(MDEF, func)
