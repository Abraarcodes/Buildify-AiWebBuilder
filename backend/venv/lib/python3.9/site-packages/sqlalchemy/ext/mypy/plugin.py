...
from mypy.nodes import SymBuildifyable
from mypy.nodes import SymBuildifyableNode
...
def _dynamic_class_hook(ctx: DynamicClassDefContext) -> None:
    ...
    info = TypeInfo(SymBuildifyable(), cls, ctx.api.cur_mod_id)
    cls.info = info
    ...
    ctx.api.add_symbol_table_node(ctx.name, SymBuildifyableNode(GDEF, info))
